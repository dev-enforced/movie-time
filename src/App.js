...
var movieDB = {
  ...
  "Maratha Culture": [
    {
      img: "https://upload.wikimedia.org/wikipedia/en/c/c0/Bajirao_Mastani_poster.jpg",
      movieName: "Bajirao Mastani",
      personality: "Peshwa Bajirao I"
    },
    {
      img: "https://upload.wikimedia.org/wikipedia/en/3/3f/Tanaji_film_poster.jpg",
      movieName: "Tanhaji:The Unsung Warrior",
      personality: "Tanaji Malusare"
    },
    {
      img: "https://upload.wikimedia.org/wikipedia/en/5/54/Panipat_%28film%29_poster.jpg",
      movieName: "Panipat the Great Betrayal",
      personality: "Third Battle of Panipat"
    }
  ],
  "Social Empowerment": [
    {
      img: "https://upload.wikimedia.org/wikipedia/en/thumb/c/c2/Padman_poster.jpg/220px-Padman_poster.jpg",
      movieName: "Padman",
      personality: "Emphasis on Sanitary Hygeine"
    },
    {
      img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQXcoP6C8Hz9RkDb_B75TIw7R0WxyY4txgXuQ&usqp=CAU",
      movieName: "Toilet:Ek Prem Katha",
      personality: "Eradication of Open Defecation in Rural Areas"
    },
    {
      img: "https://upload.wikimedia.org/wikipedia/en/3/3b/Rough_Book_hindi_film_poster.jpg",
      movieName: "Rough Book",
      personality: "India's education system and its struggles"
    }
  ]
};
      ...
      <div className="main-content">
        ...
        <div className="main-body">
          <div className="btnContainer">
            {genres.map((item) => {
              return <button onClick={()=>genreClick(item)} className="button">{item}</button>;
            })}
          </div>
